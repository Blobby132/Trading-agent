...
def params_to_configs(
    ...
    agent_cfg = AgentConfig(
        ...
        trend_tilt=float(params.get("trend_tilt", 0.0)),
        accel_tilt=float(params.get("accel_tilt", 0.0)),
        tilt_lookback=int(params.get("tilt_lookback", 90)),
        tilt_rank_window=int(params.get("tilt_rank_window", 365)),
